...
const hackathonSchema = new mongoose.Schema(
  {
    host: { type: String, required: [true, "host is required"], lowercase: true },
    name: { type: String, required: [true, "Name is required."] },
    vanity: { type: String, required: [true, "Vanity is required."], lowercase: true },
    ...
    duration: { type: Number, required: [true, "Duration is required in min."] },
  },
  { timestamps: true }
);

const UpcomingHackathon = mongoose.model(
  "UpcomingHackathon",
  hackathonSchema,
  "upcominghackathons"
);
