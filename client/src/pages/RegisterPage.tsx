  ...
  return (
    <div className="ca-auth-wrap animate-fade-in">
      ...
      <div className="ca-auth-card animate-slide-up">
        <div className="ca-auth-icon">🚀</div>
        <h1 className="ca-auth-title">Create Account</h1>
        <p className="ca-auth-subtitle">Join the ultimate competitive programming platform.</p>

        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <label className="ca-field" style={{ textAlign: "left" }}>
            <span className="ca-fieldLabel">Full Name</span>
            <div className="ca-input-wrap">
              ...
              <input type="text" className="ca-input" value={name} onChange={e => setName(e.target.value)} placeholder="John Doe" required />
            </div>
          </label>
